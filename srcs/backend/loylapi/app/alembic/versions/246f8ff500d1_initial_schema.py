...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_businesses_owner_email"), "businesses", ["owner_email"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "SUCCESS", "FAILED", "RETRY", name="task_status_enum"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_celery_task_logs_queue"), "celery_task_logs", ["queue"], unique=False
    )
    op.create_index(
        op.f("ix_celery_task_logs_status"), "celery_task_logs", ["status"], unique=False
    )
    op.create_table(
        "users",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "tx_type",
            sa.Enum("EARN", "REDEEM", "SWAP_IN", "SWAP_OUT", name="tx_type_enum"),
            nullable=False,
        ),
        sa.Column("amount", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_point_txs_wallet_id"), "point_txs", ["wallet_id"], unique=False
    )
    op.create_table(
        "swap_txs",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "REDEEMED", "EXPIRED", name="voucher_status_enum"),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["template_id"], ["voucher_templates.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="SET NULL"),
        sa.PrimaryKeyConstraint("id"),
